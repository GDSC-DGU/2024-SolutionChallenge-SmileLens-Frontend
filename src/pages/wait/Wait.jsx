...
function Wait() {
  return (
    <S.WaitWrapper style={WaitWrapperStyle}>
      <div className="Frame9" style={FrameStyle}>
        ...
        <div className="Ai" style={{ width: 360, height: 7.26, left: 0, top: 97, position: 'absolute', textAlign: 'center', color: '#484747', fontSize: 20, fontFamily: 'Noto Sans KR', fontWeight: '900', wordWrap: 'break-word', lineHeight: '1.3' }}>업로드가 완료되었습니다.<br />잠시만 기다려주세요.</div>
        ...
        {renderGroup(
          ...
          <div style={{ width: 124.90, height: 23.75, left: 50, top: 145.65, position: 'absolute', textAlign: 'center', color: '#862735', fontSize: 16, fontFamily: 'Noto Sans KR', fontWeight: '700', wordWrap: 'break-word' }}>waiting 넣을지 <br />말지 고민</div>
        </div>
