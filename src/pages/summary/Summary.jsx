...
const renderSummaryContent = (summary, all, file_path, all_text ) => {
    ...
    <React.Fragment>
      <div className="Frame10" style={{ width: 331, height: frameHeight, left: 20, top: 150, position: 'relative' }}>
        ...
        <div className="Group446" style={{ width: 294.23, height: 34, left: 12, top: 26, position: 'absolute' }}>
          {renderButton("음성으로 변환하기", "/voice", { summary, all, file_path, all_text })} 
          {renderButton("내용 원문 보기", "/letter", { summary, all, file_path, all_text })}        
        </div>
      </div>
    </React.Fragment>
  );
  ...
  return (
    <S.SummaryWrapper style={SummaryWrapperStyle}>
      <div className="Frame9" style={FrameStyle}>
        ...
        {renderSummaryContent(summary, all, file_path, all_text)}
      </div>
    </S.SummaryWrapper>
  );
};
