...
function CreatorSignUp() {
  ...
  <img src={backImage} alt="backImage" style={{ width: 23, height: 40, left: -10, top: -65, position: 'absolute'}} />
    ...
    회원가입
      ...
      <div style={{width: 71, height: 9, left: 0, top: 269, position: 'absolute', color: 'white', fontSize: 12, fontFamily: 'Karla', fontWeight: '700', lineHeight: 20, wordWrap: 'break-word'}}>* 한 줄 소개</div>
  ...
  <input
    ...
    onChange={(e) => handleInputChange('introduceData', e.target.value)}
    style={{
      width: 259,
      height: 26,
      left: 0,
  ...
  />
    ...
    {/*유저/크리에이터*/}
        ...
        <div style={{width: 120, height: 5, left: 0, top: -106, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 12, fontFamily: 'Karla', fontWeight: '700', lineHeight: 20, wordWrap: 'break-word'}}>크리에이터</div>
        ...
        <div style={{width: 119, height: 8, left: 140, top: -79, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 12, fontFamily: 'Karla', fontWeight: '700', lineHeight: 20, wordWrap: 'break-word'}}>유저</div>
  ...
  <div style={{ width: 154.02, height: 7.26, left: 49, top: 472, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 16, fontFamily: 'Noto Sans KR', fontWeight: '700', wordWrap: 'break-word' }}>회원가입</div>
